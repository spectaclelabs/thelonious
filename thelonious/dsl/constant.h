...
#define SOURCE_SAMPLE_LVALUE(name, op)                                      \
template <size_t N>                                                         \
...
#define SOURCE_SAMPLE_RVALUE(name, op)                                      \
template <size_t N>                                                         \
operators::ConstantSource ## name ## N<N> operator op(AbstractSource<N> &&a,        \
                                                      Sample b) {           \
    return operators::ConstantSource ## name ## N<N>(a, b);                 \
...
#define SAMPLE_SOURCE_LVALUE_COMMUTATIVE(name, op)                          \
template <size_t N>                                                         \
...
#define SAMPLE_SOURCE_LVALUE_NON_COMMUTATIVE(name, op)                      \
template <size_t N>                                                         \
...
#define SAMPLE_SOURCE_RVALUE_COMMUTATIVE(name, op)                          \
template <size_t N>                                                         \
operators::ConstantSource ## name ## N<N> operator op(Sample a,             \
                                                      AbstractSource<N> &&b) {      \
    return operators::ConstantSource ## name ## N<N>(b, a);                 \
...
#define SAMPLE_SOURCE_RVALUE_NON_COMMUTATIVE(name, op)                      \
template <size_t N>                                                         \
operators::ConstantSource ## name ## N<N, true> operator op(Sample a,       \
                                                        AbstractSource<N> &&b) {    \
    return operators::ConstantSource ## name ## N<N, true>(b, a);           \
...
#define PROCESSOR_SAMPLE_LVALUE(name, op)                                   \
...
#define PROCESSOR_SAMPLE_RVALUE(name, op)                                   \
template <size_t M, size_t N>                                               \
operators::ConstantProcessor ## name ## N<M, N>                             \
        operator op(Processor<M, N> &&a, Sample b) {                        \
    return operators::ConstantProcessor ## name ## N<M, N>(a, b);           \
...
#define SAMPLE_PROCESSOR_LVALUE_COMMUTATIVE(name, op)                       \
template <size_t M, size_t N>                                               \
...
#define SAMPLE_PROCESSOR_LVALUE_NON_COMMUTATIVE(name, op)                   \
template <size_t M, size_t N>                                               \
...
#define SAMPLE_PROCESSOR_RVALUE_COMMUTATIVE(name, op)                       \
template <size_t M, size_t N>                                               \
operators::ConstantProcessor ## name ## N<M, N> operator op(Sample a,       \
                                                 Processor<M, N> &&b) {     \
    return operators::ConstantProcessor ## name ## N<M, N>(b, a);           \
...
#define SAMPLE_PROCESSOR_RVALUE_NON_COMMUTATIVE(name, op)                   \
template <size_t M, size_t N>                                               \
operators::ConstantProcessor ## name ## N<M, N, true> operator op(Sample a, \
                                                    Processor<M, N> &&b) {  \
    return operators::ConstantProcessor ## name ## N<M, N, true>(b, a);     \
...
#undef OPERATOR_LIST
#undef COMMUTATIVE_OPERATOR_LIST
#undef NON_COMMUTATIVE_OPERATOR_LIST
